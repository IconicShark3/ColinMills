...
comments: true
categories: [Week 13]
nb_path: _notebooks/2022-11-28-lesson-1-Homework.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-11-28-lesson-1-Homework.ipynb
-->
...
<span class="n">albumchoice</span> <span class="o">=</span> <span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Which Album? &quot;</span><span class="p">)</span>
<span class="n">albumchoice</span> <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="n">albumchoice</span><span class="p">)</span> <span class="o">-</span> <span class="mi">1</span>
<span class="n">trackchoice</span> <span class="o">=</span> <span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Which Track? &quot;</span><span class="p">)</span>
<span class="n">trackchoice</span> <span class="o">=</span> <span class="nb">int</span><span class="p">(</span><span class="n">trackchoice</span><span class="p">)</span> <span class="o">-</span> <span class="mi">1</span>
<span class="nb">print</span><span class="p">(</span><span class="n">albums</span><span class="p">[</span><span class="n">albumchoice</span><span class="p">][</span><span class="mi">0</span><span class="p">])</span>
<span class="nb">print</span><span class="p">(</span><span class="n">albums</span><span class="p">[</span><span class="n">albumchoice</span><span class="p">][</span><span class="mi">3</span><span class="p">][</span><span class="n">trackchoice</span><span class="p">][</span><span class="mi">1</span><span class="p">])</span>
</pre></div>
